...
//nestedFunction can access the variable internal because of closures it has access to outer functions and global variables.
...
const zooAnimals = [
  ...
  */
  function animalNames(){
    const displayNames = [];
    zooAnimals.forEach(animal => displayNames.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`))  /*Your Code Here*/
  return displayNames
  }
